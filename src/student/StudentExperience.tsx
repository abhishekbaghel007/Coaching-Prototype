...
export default function StudentExperience(props: Props) {
  ...
  const css = `
    ...
    .v7-explore{background:linear-gradient(180deg,rgba(8,11,14,.92),rgba(4,7,9,.97));backdrop-filter:blur(36px) saturate(125%);-webkit-backdrop-filter:blur(36px) saturate(125%)}
    ...
    .v7-explore{background:linear-gradient(180deg,color-mix(in srgb,var(--v-bg) 88%,#050607),color-mix(in srgb,var(--v-bg) 95%,#050607));backdrop-filter:blur(36px) saturate(125%);-webkit-backdrop-filter:blur(36px) saturate(125%)}.v7-explore-inner{max-width:1180px;margin:auto}.v7-menu-card{border-radius:20px;background:color-mix(in srgb,var(--v-text) 5%,transparent);border-color:color-mix(in srgb,var(--v-text) 9%,transparent)}
    ...
    /* FINAL APP POLISH: Study Centre surface depth */
    .v7-explore{isolation:isolate}
    .v7-explore:before{content:"";position:absolute;inset:0;pointer-events:none;background:radial-gradient(600px 380px at 18% 18%,color-mix(in srgb,#6e56ff 10%,transparent),transparent 68%),radial-gradient(560px 360px at 82% 52%,color-mix(in srgb,var(--apple-blue,#0a84ff) 7%,transparent),transparent 70%);opacity:.9;z-index:-1}
    .v7-menu-icon{position:relative;overflow:hidden;transform:translateZ(0);box-shadow:inset 0 1px rgba(255,255,255,.28),inset 0 -10px 20px rgba(0,0,0,.12),0 12px 28px color-mix(in srgb,var(--tone) 22%,transparent)!important}
    .v7-menu-icon:before{content:"";position:absolute;inset:1px;border-radius:inherit;background:linear-gradient(145deg,rgba(255,255,255,.25),transparent 42%,rgba(0,0,0,.12));pointer-events:none}
    .v7-menu-icon svg{position:relative;z-index:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,.28))}
    @media(max-width:700px){.v7-explore-inner{padding-top:calc(22px + env(safe-area-inset-top))}.v7-menu-card{background:color-mix(in srgb,var(--v-text) 4.5%,transparent)!important;box-shadow:0 10px 28px rgba(0,0,0,.14)!important}}

    /* APPLE PASS 4: Study Centre is a real surface, not a transparent overlay */
    .v7-explore{background:#07090b!important;backdrop-filter:blur(34px) saturate(120%)!important;-webkit-backdrop-filter:blur(34px) saturate(120%)!important}
    .v7-explore:before{content:"";position:absolute;inset:0;pointer-events:none;background:radial-gradient(460px 300px at 14% 18%,rgba(120,86,255,.08),transparent 70%),radial-gradient(520px 320px at 84% 56%,rgba(10,132,255,.06),transparent 72%);opacity:1;z-index:-1}
    .v7-menu-card{background:linear-gradient(145deg,rgba(255,255,255,.055),rgba(255,255,255,.022))!important;border-color:rgba(255,255,255,.105)!important;box-shadow:0 14px 34px rgba(0,0,0,.22),inset 0 1px rgba(255,255,255,.045)!important}
    .v7-menu-icon{box-shadow:inset 0 1px rgba(255,255,255,.30),inset 0 -12px 22px rgba(0,0,0,.15),0 12px 30px color-mix(in srgb,var(--tone) 25%,transparent)!important}
    @media(max-width:700px){.v7-explore-inner{padding-top:calc(18px + env(safe-area-inset-top))!important;padding-bottom:calc(36px + env(safe-area-inset-bottom))!important}.v7-explore-top{margin-bottom:28px!important}.v7-explore-top h2{font-size:32px!important;letter-spacing:-1.4px!important}.v7-menu-card{min-height:122px!important}}
