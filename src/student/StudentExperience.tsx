...
export default function StudentExperience(props: Props) {
  ...
  const css = `
    .student-v7{
      ...
      width:100%; max-width:none; margin:0 auto; padding:4px 0 60px; color:var(--v-text);
    }
    ...
    .v7-plan{display:grid;gap:10px}.v7-plan-row{display:grid;grid-template-columns:54px 44px minmax(0,1fr) 38px;align-items:center;gap:12px;padding:13px 14px;border-radius:19px;border:1px solid var(--v-line);background:rgba(255,255,255,.025);transition:.18s ease}.v7-plan-row:hover{transform:translateY(-1px);border-color:rgba(255,255,255,.13)}.v7-time{font-size:8px;color:#7c898f;font-weight:950;letter-spacing:.12em}.v7-plan-icon{width:44px;height:44px;border-radius:14px;display:grid;place-items:center;background:rgba(255,255,255,.055);color:#e9b44f}.v7-plan-copy{min-width:0}.v7-plan-copy b{display:block;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v7-plan-copy span{display:block;color:#88949a;font-size:9px;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v7-plan-row button{width:38px;height:38px;border:1px solid rgba(255,255,255,.08);border-radius:50%;padding:0;background:rgba(255,255,255,.05);color:#e7ecee;font-size:17px;font-weight:500;display:grid;place-items:center}
    ...
    /* ============================================================
       STUDENT HOME APPLE PASS 3.0
       ============================================================ */
    .student-v7{padding:0 0 80px!important;color:#f5f6f7!important;background:#080a0d!important}
    .v7-top{height:70px!important;padding:0 0 0!important;border-bottom:1px solid rgba(255,255,255,.055)!important;position:sticky!important;top:0!important;z-index:20!important;background:rgba(8,10,13,.78)!important;backdrop-filter:saturate(180%) blur(26px)!important;-webkit-backdrop-filter:saturate(180%) blur(26px)!important}
    .v7-logo{width:42px!important;height:42px!important;border-radius:13px!important;background:#f0b83f!important;color:#17130a!important;box-shadow:0 8px 25px rgba(240,184,63,.13)!important}
    .v7-brand-name{font-size:20px!important;letter-spacing:-.9px!important}.v7-brand-name span{color:#f0b83f!important}
    .v7-actions{gap:7px!important}.v7-round{width:40px!important;height:40px!important;border-radius:50%!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.075)!important;box-shadow:inset 0 1px rgba(255,255,255,.025)!important}.v7-round:hover{background:rgba(255,255,255,.07)!important}.v7-avatar{background:rgba(255,255,255,.055)!important;font-size:12px!important}
    .v7-welcome{padding:44px 0 20px!important}.v7-welcome small{font-size:8px!important;letter-spacing:.16em!important;color:#77838a!important}.v7-welcome h1{font-size:clamp(38px,5vw,58px)!important;letter-spacing:-.055em!important;line-height:1.02!important;margin:10px 0 10px!important}.v7-welcome h1 .gold{color:#fff!important}.v7-welcome p{font-size:13px!important;max-width:560px!important;color:#89949b!important;line-height:1.55!important}
    .v7-course{margin:0 0 16px!important;width:100%!important;padding:13px 14px!important;border-radius:18px!important;background:#111419!important;border:1px solid rgba(255,255,255,.065)!important;box-shadow:0 12px 35px rgba(0,0,0,.12)!important}.v7-course-icon{width:42px!important;height:42px!important;border-radius:13px!important;background:rgba(240,184,63,.09)!important;color:#f0b83f!important}.v7-course-copy small{font-size:7px!important;letter-spacing:.14em!important}.v7-course-copy b{font-size:12px!important}.v7-edit{color:#f0b83f!important;font-size:8px!important}
    .v7-hero{border-radius:28px!important;padding:30px!important;background:linear-gradient(145deg,#17191e 0%,#101216 100%)!important;border:1px solid rgba(255,255,255,.075)!important;box-shadow:0 25px 80px rgba(0,0,0,.24)!important}.v7-hero:before{width:420px!important;height:420px!important;right:-210px!important;top:-250px!important;border-color:rgba(0,122,255,.10)!important}.v7-hero:after{width:290px!important;height:290px!important;right:-140px!important;top:-170px!important;border-color:rgba(0,122,255,.08)!important}.v7-kicker{color:#65c8ff!important;font-size:8px!important;letter-spacing:.16em!important}.v7-hero h2{font-size:clamp(28px,4vw,42px)!important;letter-spacing:-.055em!important;line-height:1!important;max-width:620px!important}.v7-hero p{font-size:12px!important;color:#9ca6ad!important;max-width:540px!important}.v7-ring{width:86px!important;height:86px!important;background:conic-gradient(#007aff var(--v7p),rgba(255,255,255,.08) 0)!important}.v7-ring:before{background:#171a20!important}.v7-chip{padding:7px 9px!important;background:rgba(255,255,255,.055)!important;border-color:rgba(255,255,255,.065)!important;font-size:8px!important}.v7-hero-btn{margin-top:20px!important;border-radius:999px!important;padding:13px 17px!important;background:#fff!important;color:#111!important;font-size:10px!important;box-shadow:0 12px 30px rgba(0,0,0,.18)!important}
    .v7-section{margin-top:42px!important}.v7-head{margin-bottom:14px!important}.v7-label{font-size:8px!important;letter-spacing:.16em!important;color:#737e85!important}.v7-head h2{font-size:26px!important;letter-spacing:-.045em!important}.v7-link{color:#2997ff!important;font-size:10px!important}
    .v7-quick{gap:10px!important}.v7-quick-card{min-height:118px!important;padding:16px!important;border-radius:20px!important;background:#111419!important;border:1px solid rgba(255,255,255,.06)!important;box-shadow:0 12px 32px rgba(0,0,0,.11)!important;display:grid!important}.v7-quick-card:hover{transform:translateY(-2px)!important;background:#14171c!important}.v7-quick-icon{width:43px!important;height:43px!important;border-radius:14px!important;box-shadow:none!important}.v7-quick-card b{font-size:13px!important}.v7-quick-card span:not(.v7-arrow){font-size:8px!important;color:#7d878e!important}.v7-arrow{font-size:21px!important;color:#747f86!important}
    .v7-continue,.v7-progress,.v7-plan-row,.v7-subject,.v7-signal,.v7-streak,.v7-recovery,.v7-course{background:#111419!important;border-color:rgba(255,255,255,.06)!important;box-shadow:0 10px 30px rgba(0,0,0,.10)!important}.v7-continue,.v7-progress,.v7-streak,.v7-recovery{border-radius:21px!important}.v7-plan-row{border-radius:18px!important}.v7-start,.v7-plan-row button{background:rgba(255,255,255,.055)!important;color:#2997ff!important;border:1px solid rgba(255,255,255,.06)!important}.v7-bigbar,.v7-track{background:#262a30!important}.v7-bigbar i,.v7-track i{background:#007aff!important}.v7-progress-ring{background:conic-gradient(#007aff var(--v7p),#292d33 0)!important}.v7-progress-ring:before{background:#111419!important}
    .v7-explore{background:rgba(0,0,0,.64)!important;backdrop-filter:blur(32px)!important;-webkit-backdrop-filter:blur(32px)!important}.v7-explore-inner{background:rgba(20,22,27,.94)!important;border:1px solid rgba(255,255,255,.08)!important;border-radius:30px!important;box-shadow:0 30px 100px rgba(0,0,0,.5)!important}.v7-menu-card{background:#181b21!important;border:1px solid rgba(255,255,255,.055)!important;border-radius:18px!important}.v7-menu-icon{border-radius:13px!important}
    .v7-dna-modal{background:#15181d!important;border:1px solid rgba(255,255,255,.09)!important;border-radius:28px!important;box-shadow:0 30px 100px rgba(0,0,0,.55)!important}.v7-dna-modal h2{font-size:30px!important;letter-spacing:-.05em!important}.v7-form select,.v7-form input{background:#101318!important;border:1px solid rgba(255,255,255,.07)!important;border-radius:14px!important}.v7-form-actions button{border-radius:999px!important}
    @media(max-width:700px){
      .student-v7{padding:0 0 42px!important}.v7-top{height:62px!important}.v7-logo{width:38px!important;height:38px!important;border-radius:12px!important}.v7-brand-name{font-size:18px!important}.v7-round{width:37px!important;height:37px!important}.v7-actions{gap:5px!important}.v7-welcome{padding:32px 0 17px!important}.v7-welcome h1{font-size:35px!important;line-height:1.01!important}.v7-welcome p{font-size:12px!important}.v7-course{border-radius:17px!important}.v7-hero{padding:22px 18px 19px!important;border-radius:24px!important}.v7-hero h2{font-size:28px!important;max-width:calc(100% - 68px)!important}.v7-ring{width:67px!important;height:67px!important}.v7-chip{font-size:7px!important}.v7-hero-btn{padding:12px 15px!important}.v7-section{margin-top:32px!important}.v7-head h2{font-size:22px!important}.v7-quick{grid-template-columns:1fr 1fr!important;gap:8px!important}.v7-quick-card{min-height:98px!important;padding:12px!important;border-radius:17px!important}.v7-quick-icon{width:38px!important;height:38px!important;border-radius:12px!important}.v7-quick-card b{font-size:11px!important}.v7-arrow{font-size:18px!important}
    }
    .student-v7 *{scrollbar-width:thin}
    @media(prefers-reduced-motion:reduce){.student-v7 *{transition:none!important;animation:none!important}}
    /* Endgame settings + plan refinement */
    .v7-dna-backdrop{background:rgba(3,6,8,.68);backdrop-filter:blur(22px) saturate(125%);-webkit-backdrop-filter:blur(22px) saturate(125%)}
    .v7-dna-modal{width:min(560px,calc(100vw - 28px));max-width:560px!important;padding:28px!important;border-radius:30px!important;background:rgba(18,23,28,.96)!important;border:1px solid rgba(255,255,255,.10)!important;box-shadow:0 30px 100px rgba(0,0,0,.48)!important}
    .v7-dna-modal h2{font-size:30px!important;letter-spacing:-1.3px!important;margin:7px 0 8px!important}.v7-dna-modal>p{font-size:12px!important;line-height:1.55!important;color:#8e9aa1!important;max-width:430px}
    .v7-form{gap:8px!important;margin-top:22px!important}.v7-setting-row{position:relative;display:grid!important;grid-template-columns:44px minmax(0,1fr) auto;align-items:center;gap:12px;min-height:64px;padding:9px 12px;border-radius:18px;background:rgba(255,255,255,.045);border:1px solid rgba(255,255,255,.075);color:#fff;cursor:pointer;overflow:hidden}.v7-setting-row:hover{background:rgba(255,255,255,.065);border-color:rgba(255,255,255,.12)}.v7-setting-icon{width:42px;height:42px;border-radius:14px;display:grid;place-items:center;background:rgba(255,255,255,.065);color:#e9b44f;font-size:18px}.v7-setting-copy{min-width:0}.v7-setting-copy small{display:block;color:#77858d;font-size:8px;letter-spacing:.12em;font-weight:900;margin-bottom:4px}.v7-setting-copy b{display:block;color:#f5f6f7;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v7-setting-arrow{font-size:24px;line-height:1;color:#748188}.v7-setting-row select{position:absolute;inset:0;width:100%;height:100%;opacity:0;cursor:pointer;margin:0!important;padding:0!important}.v7-hours-row{cursor:default}.v7-stepper{display:flex;align-items:center;gap:8px}.v7-stepper button{width:32px;height:32px;border-radius:50%;border:1px solid rgba(255,255,255,.09);background:rgba(255,255,255,.06);color:#fff;font-size:20px;line-height:1}.v7-stepper strong{width:24px;text-align:center;font-size:12px}.v7-form-actions{display:grid!important;grid-template-columns:1fr 1.45fr;gap:8px!important;margin-top:10px!important}.v7-form-actions button{height:46px;border-radius:15px!important;font-size:10px!important}.v7-form-actions .alt{background:rgba(255,255,255,.055)!important;color:#d9dee0!important;border:1px solid rgba(255,255,255,.08)!important}.v7-form-actions .main{background:#f4f5f4!important;color:#101416!important}
    .v7-plan-row button{font-size:0!important}.v7-plan-row button::after{content:'›';font-size:19px;font-weight:400}
    @media(max-width:700px){.v7-dna-modal{padding:22px!important;border-radius:26px!important}.v7-dna-modal h2{font-size:27px!important}.v7-setting-row{min-height:60px;border-radius:16px}.v7-setting-icon{width:38px;height:38px;border-radius:12px}.v7-setting-copy b{font-size:11px}.v7-plan-row{grid-template-columns:34px 38px minmax(0,1fr) 34px!important;gap:8px!important}.v7-time{font-size:6px}.v7-plan-icon{width:38px;height:38px}.v7-plan-copy b{font-size:9px}.v7-plan-copy span{font-size:7px}.v7-plan-row button{width:34px;height:34px!important}.v7-form-actions{grid-template-columns:1fr 1.4fr!important}}


    /* NEETPrep visual polish: preserve the existing home, refine hierarchy and density. */
    .student-v7{max-width:none;padding:8px 0 72px}
    ...
    .v7-plan{gap:7px}
    .v7-plan-row{grid-template-columns:52px 42px minmax(0,1fr) 36px;padding:12px 13px;border-radius:18px;background:rgba(255,255,255,.023)}
    .v7-plan-icon{width:40px;height:40px;border-radius:12px}
    .v7-plan-copy b{font-size:10px}.v7-plan-copy span{font-size:8px}
    .v7-plan-row button{width:36px;height:36px;padding:0;border-radius:50%;font-size:16px}
    ...
    @media(max-width:700px){
      ...
      .v7-plan-row{grid-template-columns:36px 40px minmax(0,1fr) 34px;gap:8px;padding:11px 10px}.v7-time{display:block;font-size:7px}.v7-plan-icon{width:40px;height:40px}.v7-plan-copy b{font-size:10px}.v7-plan-copy span{font-size:7px}.v7-plan-row button{width:34px;height:34px;font-size:15px;padding:0}
  ...
  return (
    <>
      ...
      {dnaOpen && (
        <div className="modal-backdrop v7-dna-backdrop" onMouseDown={() => setDnaOpen(false)}>
          <div className="modal v7-dna-modal" onMouseDown={e => e.stopPropagation()}>
            ...
            <h2>Make your setup yours.</h2>
            <p>Tell NEETPrep a little about your routine. You can change this anytime.</p>
            <div className="v7-form">
              <label className="v7-setting-row">
                <span className="v7-setting-icon">⌁</span><span className="v7-setting-copy"><small>STAGE</small><b>{dna.stage}</b></span><span className="v7-setting-arrow">›</span>
                <select aria-label="Stage" value={dna.stage} onChange={e => setDna(prev => ({ ...prev, stage: e.target.value as PrepDNA['stage'] }))}><option>Class 11</option><option>Class 12</option><option>Dropper</option></select>
              </label>
              <label className="v7-setting-row">
                <span className="v7-setting-icon">◫</span><span className="v7-setting-copy"><small>COACHING</small><b>{dna.coaching}</b></span><span className="v7-setting-arrow">›</span>
                <select aria-label="Coaching" value={dna.coaching} onChange={e => setDna(prev => ({ ...prev, coaching: e.target.value as PrepDNA['coaching'] }))}><option>Offline coaching</option><option>Online coaching</option><option>Hybrid</option><option>Self study</option></select>
              </label>
              <div className="v7-setting-row v7-hours-row">
                <span className="v7-setting-icon">◷</span><span className="v7-setting-copy"><small>DAILY STUDY HOURS</small><b>{dna.hours} hours</b></span>
                <div className="v7-stepper"><button type="button" onClick={() => setDna(prev => ({ ...prev, hours: Math.max(1, prev.hours - 1) }))}>−</button><strong>{dna.hours}</strong><button type="button" onClick={() => setDna(prev => ({ ...prev, hours: Math.min(16, prev.hours + 1) }))}>+</button></div>
              </div>
              <label className="v7-setting-row">
                <span className="v7-setting-icon">☼</span><span className="v7-setting-copy"><small>BEST FOCUS WINDOW</small><b>{dna.focus}</b></span><span className="v7-setting-arrow">›</span>
                <select aria-label="Best focus window" value={dna.focus} onChange={e => setDna(prev => ({ ...prev, focus: e.target.value as PrepDNA['focus'] }))}><option>Morning</option><option>Afternoon</option><option>Evening</option><option>Night</option></select>
              </label>
