...
export default function App() {
  ...
  useEffect(() => {
    ...
    const arm = () => {
      ...
      if (!state || state.__neetprepBackGuard !== marker) {
        window.history.pushState({ ...(state || {}), __neetprepBackGuard: marker, __neetprepGuardLayer: 1 }, '', window.location.href);
      }
  ...
  const mobilePolishCss = `
    ...
    *{box-sizing:border-box}
    ...
    .back-menu{width:min(560px,100%);border:1px solid color-mix(in srgb,var(--np-text) 10%,transparent);border-radius:30px;background:color-mix(in srgb,var(--np-surface) 96%,transparent);box-shadow:0 28px 100px rgba(0,0,0,.42),inset 0 1px rgba(255,255,255,.04);padding:10px 18px max(18px,env(safe-area-inset-bottom));backdrop-filter:blur(32px) saturate(150%);-webkit-backdrop-filter:blur(32px) saturate(150%)}
    .back-menu-handle{width:38px;height:4px;border-radius:99px;background:color-mix(in srgb,var(--np-text) 20%,transparent);margin:4px auto 18px}.back-menu-head{display:flex;align-items:flex-start;justify-content:space-between;padding:0 2px 16px;border-bottom:1px solid color-mix(in srgb,var(--np-text) 8%,transparent)}.back-menu-head h2{margin:5px 0 0;font-size:26px;letter-spacing:-1.2px}.back-menu-close{width:34px;height:34px;border:0;border-radius:50%;background:color-mix(in srgb,var(--np-text) 7%,transparent);color:var(--np-text);font-size:20px;cursor:pointer}.back-menu-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;padding:16px 0}.back-menu-grid button{min-height:74px;border:1px solid color-mix(in srgb,var(--np-text) 8%,transparent);border-radius:18px;background:color-mix(in srgb,var(--np-text) 4%,transparent);color:var(--np-text);display:flex;flex-direction:column;align-items:flex-start;justify-content:space-between;padding:12px;cursor:pointer;text-align:left}.back-menu-grid button span{width:31px;height:31px;border-radius:11px;display:grid;place-items:center;background:color-mix(in srgb,var(--apple-blue) 12%,transparent);color:var(--apple-blue);font-size:17px}.back-menu-grid button b{font-size:11px}.back-menu-grid button.active{border-color:color-mix(in srgb,var(--apple-blue) 55%,transparent);background:color-mix(in srgb,var(--apple-blue) 8%,transparent)}.back-menu-account{padding-top:2px}.back-menu-account button{width:100%;display:grid;grid-template-columns:42px 1fr 20px;align-items:center;gap:11px;border:0;border-top:1px solid color-mix(in srgb,var(--np-text) 8%,transparent);padding:15px 2px 4px;background:transparent;color:var(--np-text);text-align:left;cursor:pointer}.back-menu-account button>span{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:var(--apple-blue);color:#fff;font-weight:900}.back-menu-account b{display:block;font-size:12px}.back-menu-account small{display:block;color:var(--np-muted);font-size:9px;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.back-menu-account strong{font-size:22px;font-weight:300;color:var(--np-muted)}
    ...
    .cbt-topbar{
      ...
      background:color-mix(in srgb,var(--np-bg) 82%,transparent)!important;
      backdrop-filter:blur(24px) saturate(145%)!important;
      -webkit-backdrop-filter:blur(24px) saturate(145%)!important;
      border-bottom:1px solid color-mix(in srgb,var(--np-text) 8%,transparent)!important;
    }
    .cbt-question-area{
    ...
    .cbt-option{
      ...
      background:linear-gradient(180deg,
        color-mix(in srgb,var(--np-text) 5%,transparent),
        color-mix(in srgb,var(--np-text) 2.5%,transparent))!important;
      border:1px solid color-mix(in srgb,var(--np-text) 9%,transparent)!important;
    ...
    @media(max-width:760px){
      ...
      .cbt-actions-mobile{
        ...
        border:1px solid color-mix(in srgb,var(--np-text) 11%,transparent)!important;
      ...
      .cbt-mobile-end{
        background:color-mix(in srgb,var(--np-text) 6%,transparent)!important;
        border:1px solid color-mix(in srgb,var(--np-text) 7%,transparent)!important;
    ...
    .practice-actionbar{
      border:1px solid color-mix(in srgb,var(--np-text) 10%,transparent)!important;
      background:color-mix(in srgb,var(--np-surface) 91%,transparent)!important;
    ...
    .solver-action-icon.active{
      background:color-mix(in srgb,var(--np-text) 7%,transparent)!important;
      color:var(--np-text)!important;
    }
    .practice-next{
    ...
    @media(max-width:760px){
      ...
      html,body,#root{background:var(--v-bg,#080b0e)!important;color:var(--v-text,#f5f5f7)!important;overscroll-behavior-y:none!important}
      .app{background:var(--v-bg,#080b0e)!important;min-height:100dvh!important}
      @media(max-width:700px){
        html,body,#root{background:var(--v-bg,#080b0e)!important}
        body{margin:0!important;padding:0!important}
        .v7-top{padding-top:max(10px,env(safe-area-inset-top))!important;min-height:58px!important;box-sizing:content-box!important;background:color-mix(in srgb,var(--v-bg) 94%,transparent)!important}
      }
      /* FINAL BACK/STATUS/OVERLAY POLISH */
      .back-menu-backdrop{background:color-mix(in srgb,var(--v-bg) 72%,#000 28%)!important;backdrop-filter:blur(34px) saturate(135%)!important;-webkit-backdrop-filter:blur(34px) saturate(135%)!important}
      .back-menu{background:color-mix(in srgb,var(--v-panel) 96%,transparent)!important;border:1px solid color-mix(in srgb,var(--v-text) 10%,transparent)!important;box-shadow:0 30px 100px rgba(0,0,0,.48)!important}
