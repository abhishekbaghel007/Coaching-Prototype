...
export default function App() {
  ...
  const mobilePolishCss = `
    ...
    *{box-sizing:border-box}
    ...
    /* Light appearance overrides for the existing app shell */
    .app[data-appearance='light']{--app-bg:#f5f5f7;--app-panel:#fff;--app-panel-2:#f1f1f4;--app-line:rgba(0,0,0,.08);--app-muted:#77777f;background:#f5f5f7!important;color:#171719!important}.app[data-appearance='light'] .top-nav{background:rgba(255,255,255,.78)!important;border-bottom-color:rgba(0,0,0,.06)!important}.app[data-appearance='light'] .top-nav nav button,.app[data-appearance='light'] .nav-theme,.app[data-appearance='light'] .nav-search,.app[data-appearance='light'] .nav-bell,.app[data-appearance='light'] .nav-avatar{color:#4b4b52!important;background:rgba(255,255,255,.72)!important;border-color:rgba(0,0,0,.07)!important}.app[data-appearance='light'] .student-home-stage,.app[data-appearance='light'] .coaching-home-page{background:#f5f5f7!important}.app[data-appearance='light'] .mobile-bottom{background:rgba(255,255,255,.90)!important;border-color:rgba(0,0,0,.08)!important;box-shadow:0 16px 50px rgba(0,0,0,.12)!important}.app[data-appearance='light'] .mobile-bottom button{color:#77777f}.app[data-appearance='light'] .mobile-bottom button.active{color:var(--accent);background:rgba(0,0,0,.035)}
    /* Appearance sheet: consistent with the app's actual mode */
    .appearance-modal{width:min(470px,calc(100vw - 28px))!important;padding:27px!important;border-radius:28px!important;background:rgba(18,23,28,.97)!important;border:1px solid rgba(255,255,255,.10)!important;box-shadow:0 30px 100px rgba(0,0,0,.48)!important}.appearance-modal h2{font-size:29px!important;letter-spacing:-1px!important;margin:7px 0 6px!important}.appearance-note{font-size:11px!important;color:#8d99a0!important;margin:0!important}.appearance-section{margin-top:22px!important}.appearance-section>small{font-size:8px!important;letter-spacing:.14em!important;color:#78858d!important}.mode-toggle{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px!important;margin-top:9px!important}.mode-toggle button{position:relative!important;min-height:56px!important;padding:10px 12px!important;border-radius:15px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.09)!important;color:#e9edef!important;text-align:left!important;display:grid!important;grid-template-columns:31px 1fr 18px!important;align-items:center!important;gap:8px!important}.mode-toggle button>span{width:31px;height:31px;border-radius:10px;background:rgba(255,255,255,.06);display:grid;place-items:center;color:var(--accent);font-size:15px}.mode-toggle button.selected{background:color-mix(in srgb,var(--accent) 12%,transparent)!important;border-color:color-mix(in srgb,var(--accent) 70%,transparent)!important}.mode-toggle button em,.theme-swatches button em{font-style:normal;color:var(--accent);font-size:16px;text-align:right}.theme-swatches{grid-template-columns:1fr 1fr!important;gap:8px!important;margin-top:9px!important}.theme-swatches button{min-height:46px!important;padding:10px 12px!important;border-radius:15px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.09)!important;color:#e9edef!important;display:flex!important;align-items:center!important;gap:9px!important;position:relative!important}.theme-swatches button i{width:14px!important;height:14px!important;flex:0 0 auto!important;box-shadow:0 0 13px color-mix(in srgb,currentColor 30%,transparent)}.theme-swatches button span{font-size:11px!important}.theme-swatches button em{margin-left:auto}.appearance-footnote{margin-top:16px;padding-top:13px;border-top:1px solid rgba(255,255,255,.08);font-size:9px;color:#77858d}.app[data-appearance='light'] .appearance-modal{background:rgba(255,255,255,.98)!important;border-color:rgba(0,0,0,.08)!important;box-shadow:0 30px 100px rgba(0,0,0,.18)!important}.app[data-appearance='light'] .appearance-modal h2{color:#171719!important}.app[data-appearance='light'] .appearance-note,.app[data-appearance='light'] .appearance-section>small,.app[data-appearance='light'] .appearance-footnote{color:#77777f!important}.app[data-appearance='light'] .mode-toggle button,.app[data-appearance='light'] .theme-swatches button{background:#f5f5f7!important;border-color:rgba(0,0,0,.08)!important;color:#202024!important}.app[data-appearance='light'] .mode-toggle button.selected,.app[data-appearance='light'] .theme-swatches button.selected{background:color-mix(in srgb,var(--accent) 10%,white)!important;border-color:color-mix(in srgb,var(--accent) 55%,rgba(0,0,0,.08))!important}.app[data-appearance='light'] .mode-toggle button>span{background:#ededf0}.app[data-appearance='light'] .appearance-footnote{border-top-color:rgba(0,0,0,.08)}
    /* ============================================================
       NEETPREP APPLE PASS 3.0
       App-only visual overrides. Logic and information architecture
       intentionally remain unchanged.
       ============================================================ */
    .top-nav{
      height:72px!important;padding:0 22px!important;gap:24px!important;
      background:rgba(10,13,17,.78)!important;
      border-bottom:1px solid rgba(255,255,255,.055)!important;
      backdrop-filter:saturate(180%) blur(28px)!important;
      -webkit-backdrop-filter:saturate(180%) blur(28px)!important;
    }
    .brand{gap:11px!important;font-size:20px!important;letter-spacing:-.9px!important}
    .brand-mark{width:40px!important;height:40px!important;border-radius:13px!important;box-shadow:0 8px 24px color-mix(in srgb,var(--accent) 16%,transparent)!important}
    .top-nav nav{gap:2px!important}
    .top-nav nav button{padding:9px 13px!important;border-radius:12px!important;font-size:11px!important;color:#858e95!important;transition:background .18s ease,color .18s ease,transform .18s ease!important}
    .top-nav nav button:hover{color:#eef2f4!important;background:rgba(255,255,255,.045)!important}
    .top-nav nav button.active{color:#f4f6f7!important;background:rgba(255,255,255,.075)!important;box-shadow:inset 0 1px rgba(255,255,255,.04)!important}
    .nav-actions{gap:7px!important}
    .nav-theme,.nav-search,.nav-bell,.nav-login,.nav-avatar{height:40px!important;border-radius:13px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.075)!important;box-shadow:inset 0 1px rgba(255,255,255,.025)!important}
    .nav-theme,.nav-search,.nav-login{padding:0 13px!important}
    .nav-theme i{width:8px!important;height:8px!important;box-shadow:0 0 12px color-mix(in srgb,var(--accent) 50%,transparent)!important}
    .nav-bell,.nav-avatar{width:40px!important;padding:0!important;display:grid!important;place-items:center!important}
    .nav-avatar{font-size:12px!important}

    /* CBT: replace the old exam-console feeling with a calm, focused reader. */
    .cbt-shell{
      min-height:100vh!important;background:#080a0d!important;color:#f4f6f8!important;
      font-family:Manrope,Inter,system-ui,sans-serif!important;
    }
    .cbt-topbar{
      height:74px!important;padding:0 24px!important;grid-template-columns:240px minmax(0,1fr) 240px!important;
      background:rgba(10,12,16,.78)!important;border-bottom:1px solid rgba(255,255,255,.065)!important;
      box-shadow:0 8px 30px rgba(0,0,0,.18)!important;backdrop-filter:saturate(180%) blur(28px)!important;
      -webkit-backdrop-filter:saturate(180%) blur(28px)!important;
    }
    .cbt-brand{gap:10px!important}.cbt-brand-mark{width:40px!important;height:40px!important;border-radius:13px!important;background:var(--accent)!important;color:#071013!important;box-shadow:0 8px 25px color-mix(in srgb,var(--accent) 18%,transparent)!important}
    .cbt-brand strong{font-size:16px!important;letter-spacing:-.6px!important}.cbt-brand small{font-size:8px!important;color:#737e86!important;margin-top:3px!important}
    .cbt-section-tabs{gap:4px!important;justify-content:center!important}
    .cbt-section-tabs button{height:38px!important;padding:0 14px!important;border:1px solid transparent!important;border-radius:12px!important;background:transparent!important;color:#7e878e!important;font-weight:800!important;font-size:10px!important;transition:.18s ease!important}
    .cbt-section-tabs button:hover:not(:disabled){background:rgba(255,255,255,.04)!important;color:#dfe5e8!important}
    .cbt-section-tabs button.active{background:rgba(255,255,255,.075)!important;color:#fff!important;border-color:rgba(255,255,255,.065)!important}
    .cbt-top-actions{gap:8px!important}.cbt-lang{height:38px!important;border-radius:12px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.07)!important;color:#aeb7bc!important;font-size:9px!important}
    .cbt-clock{min-width:98px!important;padding:7px 11px!important;border-radius:13px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.07)!important}
    .cbt-clock small{font-size:7px!important;color:#717c83!important;letter-spacing:.12em!important}.cbt-clock strong{font-size:14px!important;color:#f2f5f6!important}.cbt-clock.danger strong{color:#ff8d82!important}
    .cbt-profile{width:38px!important;height:38px!important;border-radius:50%!important;background:rgba(255,255,255,.055)!important;border:1px solid rgba(255,255,255,.075)!important;color:#f3f5f6!important;font-weight:900!important}
    .cbt-mobile-section{display:none!important}
    .cbt-layout{grid-template-columns:minmax(0,760px) 280px!important;gap:22px!important;width:min(1080px,calc(100% - 48px))!important;margin:26px auto 96px!important;align-items:start!important}
    .cbt-question-area{background:transparent!important;padding:0!important}
    .cbt-question-head{padding:0 3px 12px!important}.cbt-question-head span{font-size:8px!important;letter-spacing:.12em!important;color:#747f87!important;text-transform:uppercase!important}.cbt-question-head h1{font-size:25px!important;letter-spacing:-.045em!important;margin-top:5px!important}.cbt-progress-label{font-size:9px!important;color:#818c93!important;padding-top:7px!important}
    .cbt-instruction-strip{display:flex!important;gap:7px!important;margin-bottom:12px!important}.cbt-instruction-strip span{padding:7px 9px!important;border:1px solid rgba(255,255,255,.065)!important;border-radius:999px!important;background:rgba(255,255,255,.025)!important;color:#7e898f!important;font-size:8px!important}.cbt-instruction-strip b{color:#dce3e6!important}.cbt-question-type{margin-left:auto!important;color:var(--accent)!important;border-color:color-mix(in srgb,var(--accent) 18%,rgba(255,255,255,.065))!important;background:color-mix(in srgb,var(--accent) 6%,transparent)!important}
    .cbt-question-card{padding:30px!important;border-radius:28px!important;background:#111419!important;border:1px solid rgba(255,255,255,.075)!important;box-shadow:0 25px 80px rgba(0,0,0,.22)!important}
    .cbt-q-number{font-size:8px!important;color:#7b858c!important;letter-spacing:.1em!important;text-transform:uppercase!important}.cbt-dropped-badge{border-radius:999px!important;padding:5px 8px!important;font-size:7px!important}
    .cbt-question-text{font-size:22px!important;line-height:1.62!important;letter-spacing:-.018em!important;color:#f3f5f6!important;max-width:700px!important;margin:17px 0 21px!important}
    .cbt-source-toggle{padding:10px 0!important;border-top:1px solid rgba(255,255,255,.055)!important;border-bottom:1px solid rgba(255,255,255,.055)!important}.cbt-source-toggle button{font-size:9px!important;color:var(--accent)!important}.cbt-source-toggle span{font-size:8px!important;color:#69747b!important}
    .cbt-options-heading{margin:24px 1px 10px!important}.cbt-options-heading strong{font-size:11px!important}.cbt-options-heading span{font-size:8px!important;color:#747f86!important}
    .cbt-options{gap:10px!important}
    .cbt-option{min-height:66px!important;display:grid!important;grid-template-columns:36px 25px minmax(0,1fr)!important;align-items:center!important;gap:9px!important;padding:10px 13px!important;border-radius:17px!important;background:#171a20!important;border:1px solid rgba(255,255,255,.075)!important;color:#edf1f3!important;transition:transform .16s ease,background .16s ease,border-color .16s ease!important}
    .cbt-option:hover:not(:disabled){transform:translateY(-1px)!important;background:#1a1e24!important;border-color:rgba(255,255,255,.13)!important}.cbt-option .option-radio{width:34px!important;height:34px!important;border-radius:11px!important;display:grid!important;place-items:center!important;border:1px solid rgba(255,255,255,.09)!important;background:#12151a!important;color:#727d84!important;font-size:10px!important}.cbt-option b{font-size:9px!important;color:#78838a!important}.cbt-option-label{font-size:12px!important;line-height:1.5!important;color:#dce2e5!important}.cbt-option.selected{background:color-mix(in srgb,var(--accent) 9%,#171a20)!important;border-color:color-mix(in srgb,var(--accent) 58%,transparent)!important;box-shadow:0 10px 30px color-mix(in srgb,var(--accent) 8%,transparent)!important}.cbt-option.selected .option-radio{background:var(--accent)!important;border-color:transparent!important;color:#071013!important}
    .cbt-palette{position:sticky!important;top:98px!important;width:auto!important;padding:17px!important;border:1px solid rgba(255,255,255,.075)!important;border-radius:24px!important;background:#111419!important;box-shadow:0 20px 60px rgba(0,0,0,.18)!important}.cbt-candidate{padding-bottom:14px!important;border-bottom:1px solid rgba(255,255,255,.06)!important}.candidate-avatar{width:34px!important;height:34px!important;border-radius:11px!important;background:color-mix(in srgb,var(--accent) 13%,#181c22)!important;color:var(--accent)!important}.cbt-candidate strong{font-size:10px!important}.cbt-candidate small{font-size:7px!important;color:#707b82!important}.cbt-palette-summary{grid-template-columns:1fr 1fr 1fr!important;padding:13px 0!important}.cbt-palette-summary strong{font-size:16px!important}.cbt-palette-summary span{font-size:7px!important}.cbt-palette-title{margin:4px 0 10px!important}.cbt-palette-title b{font-size:10px!important}.cbt-palette-title span{font-size:7px!important;color:#707b82!important}.cbt-palette-grid{grid-template-columns:repeat(5,1fr)!important;gap:6px!important}.palette-q{height:34px!important;border-radius:10px!important;background:#171a20!important;border:1px solid rgba(255,255,255,.065)!important;color:#89939a!important;font-size:9px!important}.palette-q.current{box-shadow:0 0 0 2px color-mix(in srgb,var(--accent) 35%,transparent)!important;color:#fff!important}.palette-q.answered{background:color-mix(in srgb,var(--accent) 14%,#171a20)!important;color:var(--accent)!important}.cbt-legend{gap:7px!important;margin-top:13px!important}.cbt-legend div{font-size:7px!important;color:#7d878d!important}.cbt-submit{height:43px!important;border-radius:13px!important;background:var(--accent)!important;color:#071013!important;border:0!important;font-weight:900!important;font-size:9px!important;margin-top:12px!important;box-shadow:0 10px 28px color-mix(in srgb,var(--accent) 16%,transparent)!important}
    .cbt-footer{height:70px!important;padding:0 24px!important;background:rgba(10,13,17,.84)!important;border-top:1px solid rgba(255,255,255,.065)!important;backdrop-filter:saturate(180%) blur(28px)!important;-webkit-backdrop-filter:saturate(180%) blur(28px)!important}.cbt-footer-center{gap:7px!important}.cbt-footer-center span{font-size:8px!important;color:#7d878d!important}.cbt-dots{height:4px!important;background:#252a30!important;border-radius:999px!important}.cbt-dots i{background:var(--accent)!important}.cbt-footer-right{gap:7px!important}.cbt-footer-right button,.cbt-back-btn{height:40px!important;padding:0 12px!important;border-radius:12px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.065)!important;color:#9ca6ab!important;font-size:8px!important}.cbt-footer-right .primary-button{background:var(--accent)!important;color:#071013!important;border:0!important}.cbt-end-btn{color:#ff8c82!important;border-color:rgba(255,120,110,.18)!important;background:rgba(255,100,90,.045)!important}
    .cbt-confirm-backdrop{background:rgba(0,0,0,.72)!important;backdrop-filter:blur(18px)!important}.cbt-confirm{width:min(440px,calc(100vw - 28px))!important;padding:26px!important;border-radius:28px!important;background:#15181d!important;border:1px solid rgba(255,255,255,.09)!important;box-shadow:0 30px 100px rgba(0,0,0,.55)!important}.cbt-confirm h2{font-size:24px!important;letter-spacing:-.04em!important}.confirm-stats{border-radius:17px!important;background:#111419!important;border-color:rgba(255,255,255,.06)!important}.confirm-actions button{border-radius:13px!important}

    /* Mobile: make CBT feel like a native reading surface, not a compressed desktop exam. */
    @media(max-width:760px){
      .top-nav{display:none!important}
      .student-home-stage{padding:0 18px!important}
      .mobile-bottom{left:12px!important;right:12px!important;bottom:max(10px,env(safe-area-inset-bottom))!important;height:68px!important;padding:5px!important;border-radius:23px!important;background:rgba(18,20,24,.88)!important;border:1px solid rgba(255,255,255,.09)!important;box-shadow:0 18px 50px rgba(0,0,0,.38)!important;backdrop-filter:saturate(180%) blur(28px)!important;-webkit-backdrop-filter:saturate(180%) blur(28px)!important}
      .mobile-bottom button{height:56px!important;border-radius:18px!important;color:#7e878e!important;gap:3px!important}.mobile-bottom button.active{background:rgba(255,255,255,.055)!important;color:#fff!important}.mobile-bottom b{font-size:7px!important;letter-spacing:.01em!important}.mobile-bottom .mobile-plus{width:58px!important;height:58px!important;margin-top:-16px!important;border-radius:20px!important;background:var(--accent)!important;color:#071013!important;box-shadow:0 12px 34px color-mix(in srgb,var(--accent) 24%,transparent)!important;font-size:0!important;border:4px solid var(--app-bg,#080a0d)!important}.mobile-bottom .mobile-plus>span{width:100%!important;height:100%!important;display:grid!important;place-items:center!important}.quick-glyph{display:grid!important;place-items:center!important;width:30px!important;height:30px!important;border-radius:10px!important;background:rgba(0,0,0,.10)!important;font-size:18px!important;font-weight:700!important;transform:rotate(-8deg)!important}
      .cbt-topbar{height:62px!important;padding:0 12px!important;display:flex!important;justify-content:space-between!important}.cbt-brand-mark{width:34px!important;height:34px!important;border-radius:11px!important}.cbt-brand strong{font-size:13px!important}.cbt-brand small{display:none!important}.cbt-section-tabs{display:none!important}.cbt-top-actions{gap:5px!important}.cbt-lang{display:none!important}.cbt-clock{min-width:70px!important;height:36px!important;padding:5px 8px!important}.cbt-clock small{font-size:6px!important}.cbt-clock strong{font-size:12px!important}.cbt-profile{width:36px!important;height:36px!important}
      .cbt-mobile-section{display:flex!important;height:48px!important;padding:0 14px!important;align-items:center!important;justify-content:space-between!important;background:rgba(255,255,255,.018)!important;border-bottom:1px solid rgba(255,255,255,.05)!important}.cbt-mobile-section span{font-size:8px!important;color:#747f86!important}.cbt-mobile-section b{color:#dfe4e7!important}.cbt-mobile-section button{border:0!important;background:rgba(255,255,255,.045)!important;border:1px solid rgba(255,255,255,.065)!important;color:#aeb7bc!important;border-radius:999px!important;padding:8px 10px!important;font-size:7px!important}
      .cbt-layout{display:block!important;width:100%!important;margin:0!important}.cbt-question-area{padding:15px 12px 112px!important}.cbt-question-head{padding:0 2px 11px!important}.cbt-question-head h1{font-size:21px!important}.cbt-progress-label{font-size:7px!important}.cbt-instruction-strip{gap:5px!important;overflow:auto!important;scrollbar-width:none!important}.cbt-instruction-strip::-webkit-scrollbar{display:none}.cbt-instruction-strip span{white-space:nowrap!important;font-size:7px!important;padding:6px 8px!important}.cbt-question-type{margin-left:0!important}
      .cbt-question-card{padding:19px 16px 17px!important;border-radius:22px!important;box-shadow:0 18px 50px rgba(0,0,0,.18)!important}.cbt-q-number{font-size:7px!important}.cbt-question-text{font-size:17px!important;line-height:1.62!important;margin:14px 0 17px!important}.cbt-source-toggle span{display:none!important}.cbt-source-toggle{padding:8px 0!important}.cbt-options-heading{margin:20px 1px 9px!important}.cbt-options-heading strong{font-size:10px!important}.cbt-options{gap:8px!important}.cbt-option{min-height:58px!important;grid-template-columns:34px 20px minmax(0,1fr)!important;padding:8px 9px!important;border-radius:15px!important}.cbt-option .option-radio{width:31px!important;height:31px!important;border-radius:10px!important}.cbt-option b{font-size:8px!important}.cbt-option-label{font-size:11px!important;line-height:1.48!important}
      .cbt-palette{position:fixed!important;left:10px!important;right:10px!important;bottom:78px!important;top:auto!important;width:auto!important;max-height:72vh!important;overflow:auto!important;z-index:90!important;border-radius:24px!important;padding:16px!important;transform:translateY(120%)!important;opacity:0!important;pointer-events:none!important;transition:transform .25s ease,opacity .25s ease!important}.cbt-palette.open{transform:translateY(0)!important;opacity:1!important;pointer-events:auto!important}.cbt-palette.closed{transform:translateY(120%)!important;opacity:0!important;pointer-events:none!important}.cbt-footer{position:fixed!important;left:10px!important;right:10px!important;bottom:10px!important;height:58px!important;padding:5px!important;border:1px solid rgba(255,255,255,.09)!important;border-radius:20px!important;background:rgba(18,20,24,.9)!important;z-index:80!important;box-shadow:0 15px 45px rgba(0,0,0,.32)!important}.cbt-footer-center{display:none!important}.cbt-back-btn{display:none!important}.cbt-footer-right{width:100%!important;display:grid!important;grid-template-columns:40px 40px minmax(0,1fr) 40px!important;gap:5px!important}.cbt-footer-right button{height:46px!important;min-width:0!important;padding:0!important;border-radius:13px!important;font-size:0!important}.cbt-footer-right button:before{font-size:14px!important}.cbt-footer-right button:nth-child(1):before{content:'⌫'}.cbt-footer-right button:nth-child(2):before{content:'⚑'}.cbt-footer-right .primary-button{font-size:9px!important;padding:0 12px!important}.cbt-footer-right .primary-button:before{content:''}.cbt-footer-right .cbt-end-btn:before{content:'•••';font-size:12px!important}.cbt-footer-right .cbt-end-btn{font-size:0!important}
    }
    .app[data-appearance='light'] .cbt-shell{background:#f5f5f7!important;color:#171719!important}.app[data-appearance='light'] .cbt-topbar,.app[data-appearance='light'] .cbt-footer{background:rgba(255,255,255,.84)!important;border-color:rgba(0,0,0,.07)!important}.app[data-appearance='light'] .cbt-question-area{background:#f5f5f7!important}.app[data-appearance='light'] .cbt-question-card,.app[data-appearance='light'] .cbt-palette{background:#fff!important;border-color:rgba(0,0,0,.075)!important;box-shadow:0 20px 60px rgba(0,0,0,.07)!important}.app[data-appearance='light'] .cbt-question-text{color:#171719!important}.app[data-appearance='light'] .cbt-option{background:#f7f7f9!important;border-color:rgba(0,0,0,.07)!important;color:#202024!important}.app[data-appearance='light'] .cbt-option-label{color:#303036!important}.app[data-appearance='light'] .cbt-option .option-radio{background:#efeff2!important;border-color:rgba(0,0,0,.08)!important}.app[data-appearance='light'] .cbt-option.selected{background:#eef6ff!important;border-color:rgba(0,122,255,.42)!important}.app[data-appearance='light'] .cbt-mobile-section{background:rgba(255,255,255,.7)!important;border-color:rgba(0,0,0,.06)!important}.app[data-appearance='light'] .mobile-bottom{background:rgba(255,255,255,.88)!important;border-color:rgba(0,0,0,.08)!important;box-shadow:0 18px 50px rgba(0,0,0,.12)!important}.app[data-appearance='light'] .mobile-bottom button{color:#77777f!important}.app[data-appearance='light'] .mobile-bottom button.active{color:#171719!important;background:rgba(0,0,0,.035)!important}.app[data-appearance='light'] .mobile-bottom .mobile-plus{border-color:#f5f5f7!important}
  ...
  return <div className="app" data-theme={theme} data-appearance={appearance} style={{ '--accent': currentTheme.color } as CSSProperties}>
    ...
    {appearanceOpen && <div className="modal-backdrop" onMouseDown={() => setAppearanceOpen(false)}><div className="modal appearance-modal" onMouseDown={e => e.stopPropagation()}><button className="close-button" onClick={() => setAppearanceOpen(false)}>×</button><span className="section-kicker">INTERFACE</span><h2>Appearance</h2><p className="appearance-note">Choose how NEETPrep looks and feels on this device.</p><div className="appearance-section"><small>MODE</small><div className="mode-toggle"><button className={appearance === 'dark' ? 'selected' : ''} onClick={() => setAppearance('dark')}><span>☾</span><b>Dark mode</b><em>{appearance === 'dark' ? '✓' : ''}</em></button><button className={appearance === 'light' ? 'selected' : ''} onClick={() => setAppearance('light')}><span>☀</span><b>Light mode</b><em>{appearance === 'light' ? '✓' : ''}</em></button></div></div><div className="appearance-section"><small>ACCENT COLOUR</small><div className="theme-swatches">{THEMES.slice(0, 6).map(t => <button key={t.id} className={theme === t.id ? 'selected' : ''} onClick={() => setTheme(t.id)}><i style={{ background: t.color }} /><span>{t.name}</span>{theme === t.id && <em>✓</em>}</button>)}</div></div><div className="appearance-footnote">Your preferences are saved on this device.</div></div></div>}
