...
export default function App() {
  ...
  function renderPractice() {
    return <main className="page endgame-practice-page">
  ...
  function renderMocks() {
    ...
    return <main className="page mock-builder-page endgame-tests-page">
  ...
  function renderProgress() {
    ...
    return <main className="page endgame-progress-page"><section className="page-title"><div><span className="section-kicker">YOUR PERFORMANCE</span><h1>Progress.</h1><p>Useful numbers, not motivational confetti. The goal is to know what needs work.</p></div></section>
  ...
  const mobilePolishCss = `
    :root{--ui-blue:#007aff;--ui-green:#34c759;--ui-red:#ff3b30;--ui-orange:#ff9500;--ui-bg:#f5f5f7;--ui-card:rgba(255,255,255,.82);--ui-line:rgba(0,0,0,.075);--ui-muted:#86868b;--ui-text:#1d1d1f}
    .app{min-height:100vh;background:#f5f5f7;color:var(--ui-text);font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text",Inter,system-ui,sans-serif}
    .app[data-appearance='dark']{--ui-bg:#0b0b0d;--ui-card:rgba(28,29,33,.82);--ui-line:rgba(255,255,255,.09);--ui-muted:#98989f;--ui-text:#f5f5f7;background:#0b0b0d;color:var(--ui-text)}
    .top-nav{height:68px;display:grid;grid-template-columns:210px 1fr auto;align-items:center;padding:0 30px;gap:20px;background:rgba(255,255,255,.76);border-bottom:1px solid var(--ui-line);backdrop-filter:blur(26px) saturate(150%);-webkit-backdrop-filter:blur(26px) saturate(150%);position:sticky;top:0;z-index:50}
    .app[data-appearance='dark'] .top-nav{background:rgba(18,18,20,.78)}
    .brand{display:flex;align-items:center;gap:10px;border:0;background:none;color:inherit;font-size:20px;font-weight:750;letter-spacing:-.055em}.brand-mark{width:36px;height:36px;border-radius:11px;display:grid;place-items:center;background:#f5b940;color:#171717;font-size:15px;font-weight:800;box-shadow:none}.brand>span:last-child>span{color:#f0b53d}
    .top-nav nav{display:flex;justify-content:center;gap:2px}.top-nav nav button{border:0;background:transparent;color:var(--ui-muted);padding:9px 12px;border-radius:999px;font-size:12px;font-weight:650;transition:.18s}.top-nav nav button:hover{color:var(--ui-text);background:rgba(0,0,0,.035)}.app[data-appearance='dark'] .top-nav nav button:hover{background:rgba(255,255,255,.055)}.top-nav nav button.active{background:rgba(0,0,0,.055);color:var(--ui-text)}.app[data-appearance='dark'] .top-nav nav button.active{background:rgba(255,255,255,.09)}
    .nav-actions{display:flex;align-items:center;gap:7px}.nav-actions button{font-size:11px}.nav-theme,.nav-search,.nav-bell,.nav-login,.nav-avatar{height:38px;border:1px solid var(--ui-line);background:var(--ui-card);color:inherit;border-radius:999px;padding:0 12px;box-shadow:0 3px 12px rgba(0,0,0,.025)}.nav-theme i{width:7px;height:7px;border-radius:50%;display:inline-block;margin-right:6px}.nav-bell{width:38px;padding:0;position:relative}.nav-bell i{position:absolute;right:1px;top:1px;min-width:13px;height:13px;border-radius:8px;background:var(--ui-red);color:#fff;font-size:7px;font-style:normal;display:grid;place-items:center}.nav-avatar{width:38px;padding:0;font-weight:750}.nav-login{color:#007aff}
    .page{width:min(1180px,calc(100% - 64px));margin:0 auto;padding:62px 0 110px}.coaching-home-page{width:100%;padding:0 0 120px;background:var(--ui-bg)}.student-home-stage{width:min(1180px,calc(100% - 64px));max-width:none;margin:0 auto;padding:0}
    .page-title{display:flex;align-items:flex-end;justify-content:space-between;gap:30px;margin-bottom:28px}.page-title h1{font-size:58px;line-height:.96;letter-spacing:-.065em;margin:8px 0 12px;font-weight:750}.page-title p{max-width:650px;color:var(--ui-muted);font-size:14px;line-height:1.55;margin:0}.section-kicker{font-size:10px;letter-spacing:.1em;color:var(--ui-muted);font-weight:750}.primary-button{border:0;border-radius:999px;background:#007aff;color:#fff;padding:12px 17px;font-weight:700;box-shadow:0 8px 20px rgba(0,122,255,.16)}.secondary-button,.ghost-button{border:1px solid var(--ui-line);border-radius:999px;background:var(--ui-card);color:inherit;padding:11px 15px;font-weight:650}
    .filter-panel{display:grid;grid-template-columns:1fr auto;gap:10px;padding:10px;border-radius:22px;border:1px solid var(--ui-line);background:var(--ui-card);box-shadow:0 10px 30px rgba(0,0,0,.035);backdrop-filter:blur(18px)}.search-field{height:48px;display:flex;align-items:center;gap:9px;padding:0 14px;border-radius:15px;border:1px solid var(--ui-line);background:rgba(0,0,0,.025)}.app[data-appearance='dark'] .search-field{background:rgba(255,255,255,.045)}.search-field span{color:var(--ui-muted)}.search-field input{width:100%;border:0;outline:0;background:none;color:inherit;font-size:13px}.filter-row{display:flex;gap:7px}.filter-row select{height:48px;min-width:130px;border:1px solid var(--ui-line);border-radius:15px;background:var(--ui-card);color:inherit;padding:0 12px;font-size:11px}.result-line{color:var(--ui-muted);font-size:11px;margin:19px 2px 11px}.result-line b{color:var(--ui-text)}
    .question-list{display:grid;gap:9px}.question-row{width:100%;min-height:96px;display:grid;grid-template-columns:48px 1fr 20px;gap:14px;align-items:center;text-align:left;padding:14px 17px;border:1px solid var(--ui-line);border-radius:20px;background:var(--ui-card);color:inherit;box-shadow:0 5px 18px rgba(0,0,0,.025);transition:.2s}.question-row:hover{transform:translateY(-2px);background:var(--ui-card);box-shadow:0 14px 30px rgba(0,0,0,.07)}.q-number{width:46px;height:46px;border-radius:14px;display:grid;place-items:center;background:#f2f2f7;color:#6e6e73;font-size:11px;font-weight:750}.app[data-appearance='dark'] .q-number{background:#242529;color:#aaa}.q-row-copy small,.q-row-copy>span{font-size:9px;color:var(--ui-muted)}.q-row-copy b{display:block;font-size:13px;line-height:1.45;margin:6px 0}.q-row-copy i{font-style:normal;color:#007aff;margin-left:7px}.question-row>strong{color:var(--ui-muted);font-size:22px;font-weight:400}
    .mock-builder-top{display:flex;justify-content:space-between;align-items:center;margin-bottom:30px}.exam-pill{padding:7px 10px;border-radius:999px;background:rgba(255,149,0,.09);color:#ff9500;font-size:9px;font-weight:750}.mock-builder-hero{display:grid;grid-template-columns:1fr 260px;gap:40px;align-items:end;margin-bottom:30px}.mock-builder-hero h1{font-size:55px;letter-spacing:-.065em;line-height:.98;margin:9px 0 14px}.mock-builder-hero p{max-width:650px;color:var(--ui-muted);font-size:13px;line-height:1.6}.mock-summary{padding:22px;border-radius:22px;background:#1d1d1f;color:#fff}.app[data-appearance='dark'] .mock-summary{background:#1c1d21}.mock-summary small{font-size:9px;color:#aaa;font-weight:750}.mock-summary strong{display:block;font-size:56px;letter-spacing:-.06em;margin:8px 0 0}.mock-summary span{color:#aaa;font-size:11px}.mock-summary hr{border:0;border-top:1px solid rgba(255,255,255,.1);margin:17px 0}.mock-summary b{font-size:10px}.mock-builder-grid{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(280px,.75fr);gap:14px}.mock-builder-left{display:grid;gap:10px}.builder-card,.mock-rules-card{border:1px solid var(--ui-line);border-radius:22px;background:var(--ui-card);padding:21px;box-shadow:0 8px 26px rgba(0,0,0,.03)}.builder-head{display:grid;grid-template-columns:40px 1fr auto;gap:12px;align-items:center;margin-bottom:18px}.step-no{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(0,122,255,.09);color:#007aff;font-size:10px;font-weight:750}.builder-head>div span{font-size:9px;color:var(--ui-muted);font-weight:750}.builder-head h2{font-size:19px;letter-spacing:-.035em;margin:3px 0 0}.builder-head>b{font-size:9px;color:var(--ui-muted)}.subject-select-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.subject-select,.count-presets button,.time-presets button{border:1px solid var(--ui-line);background:transparent;color:inherit;border-radius:16px;padding:13px;text-align:left;transition:.18s}.subject-select.selected,.count-presets button.selected,.time-presets button.selected{border-color:#007aff;background:rgba(0,122,255,.07);color:#007aff}.subject-select{display:grid;grid-template-columns:28px 1fr auto;gap:9px;align-items:center}.check-box{width:23px;height:23px;border-radius:7px;border:1px solid var(--ui-line);display:grid;place-items:center}.check-box.checked{background:#007aff;border-color:#007aff;color:#fff}.subject-select strong,.subject-select small{display:block}.subject-select strong{font-size:12px}.subject-select small{font-size:8px;color:var(--ui-muted);margin-top:3px}.subject-select em{font-size:9px;font-style:normal;color:var(--ui-muted)}.count-presets,.time-presets{display:flex;flex-wrap:wrap;gap:7px}.count-presets button,.time-presets button{text-align:center;min-width:56px;padding:10px;font-size:10px}.count-range{width:100%;margin:22px 0 7px;accent-color:#007aff}.range-foot{display:flex;justify-content:space-between;color:var(--ui-muted);font-size:9px}.custom-time{display:flex;justify-content:space-between;align-items:center;color:var(--ui-muted);font-size:10px;margin-top:13px}.custom-time input{width:90px;padding:9px 10px;border-radius:11px;border:1px solid var(--ui-line);background:transparent;color:inherit}.mock-rules-card{position:sticky;top:88px;height:max-content}.mock-rules-card h2{font-size:24px;letter-spacing:-.04em;margin:8px 0 13px}.mock-rules-card ul{padding-left:17px;color:var(--ui-muted);font-size:10px;line-height:1.8}.ready-box{display:flex;justify-content:space-between;align-items:center;padding:13px;border-radius:15px;background:rgba(0,122,255,.06);margin:18px 0}.ready-box small,.ready-box strong{display:block}.ready-box small{font-size:8px;color:#007aff;font-weight:750}.ready-box strong{font-size:12px;margin-top:3px}.ready-box>span{font-size:9px;color:var(--ui-muted)}.builder-footnote{color:var(--ui-muted);font-size:8px;text-align:center}
    .metrics-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:12px}.metric-card{min-height:155px;padding:20px;border:1px solid var(--ui-line);border-radius:22px;background:var(--ui-card);box-shadow:0 7px 24px rgba(0,0,0,.03)}.metric-card small{display:block;color:var(--ui-muted);font-size:9px;font-weight:750;letter-spacing:.06em}.metric-card strong{display:block;font-size:43px;letter-spacing:-.06em;margin-top:30px}.metric-card span{display:block;color:var(--ui-muted);font-size:9px;margin-top:4px}.performance-panel{border:1px solid var(--ui-line);border-radius:24px;background:var(--ui-card);padding:22px}.section-heading{display:flex;justify-content:space-between;align-items:flex-end}.section-heading h2{font-size:27px;letter-spacing:-.045em;margin:7px 0 0}.weak-badge{border-radius:999px;padding:7px 10px;background:rgba(255,59,48,.08);color:#ff3b30;font-size:9px;font-weight:750}.subject-performance{margin-top:24px;display:grid;gap:12px}.perf-row{display:grid;grid-template-columns:42px 1fr 60px;gap:12px;align-items:center}.subject-mark{width:42px;height:42px;border-radius:13px;display:grid;place-items:center;font-size:12px;font-weight:800}.subject-mark.blue{background:rgba(0,122,255,.1);color:#007aff}.subject-mark.teal{background:rgba(52,199,89,.1);color:#34c759}.subject-mark.mint{background:rgba(48,209,88,.1);color:#30d158}.perf-copy b{font-size:12px}.perf-copy small{display:block;color:var(--ui-muted);font-size:8px;margin-top:3px}.perf-bar{height:7px;background:rgba(0,0,0,.06);border-radius:999px;overflow:hidden;margin-top:8px}.app[data-appearance='dark'] .perf-bar{background:rgba(255,255,255,.08)}.perf-bar i{display:block;height:100%;background:#007aff;border-radius:inherit}.perf-score{text-align:right}.perf-score b{font-size:18px}.perf-score span{display:block;color:var(--ui-muted);font-size:8px}
    .practice-overlay,.cbt-shell{position:fixed;inset:0;z-index:90;background:var(--ui-bg)}.cbt-shell{font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text",Inter,system-ui,sans-serif;color:var(--ui-text)}.cbt-topbar{height:66px;display:grid;grid-template-columns:260px 1fr auto;align-items:center;padding:0 22px;background:rgba(255,255,255,.82);border-bottom:1px solid var(--ui-line);backdrop-filter:blur(24px);z-index:3}.app[data-appearance='dark'] .cbt-topbar{background:rgba(18,18,20,.86)}.cbt-brand{display:flex;align-items:center;gap:10px}.cbt-brand-mark{width:34px;height:34px;border-radius:11px;display:grid;place-items:center;background:#f5b940;color:#171717;font-weight:800}.cbt-brand strong{font-size:16px}.cbt-brand small{display:block;color:var(--ui-muted);font-size:8px;margin-top:2px}.cbt-section-tabs{display:flex;justify-content:center;gap:3px}.cbt-section-tabs button{border:0;background:transparent;border-radius:999px;padding:8px 12px;color:var(--ui-muted);font-size:10px;font-weight:650}.cbt-section-tabs button.active{background:rgba(0,122,255,.09);color:#007aff}.cbt-top-actions{display:flex;align-items:center;gap:7px}.cbt-lang{border:0;background:transparent;color:var(--ui-muted);font-size:9px}.cbt-clock{padding:6px 10px;border-radius:12px;background:rgba(0,0,0,.045)}.app[data-appearance='dark'] .cbt-clock{background:rgba(255,255,255,.06)}.cbt-clock small,.cbt-clock strong{display:block;text-align:right}.cbt-clock small{font-size:7px;color:var(--ui-muted)}.cbt-clock strong{font-size:11px;margin-top:2px}.cbt-clock.danger{color:#ff3b30}.cbt-profile{width:34px;height:34px;border-radius:50%;border:0;background:#f2f2f7;color:#6e6e73;font-weight:750}.app[data-appearance='dark'] .cbt-profile{background:#292a2e;color:#eee}.cbt-layout{height:calc(100vh - 126px);display:grid;grid-template-columns:minmax(0,1fr) 300px}.cbt-question-area{overflow:auto;padding:44px 5vw 100px}.cbt-question-head{display:flex;justify-content:space-between;align-items:flex-end;max-width:900px;margin:0 auto 16px}.cbt-question-head span{font-size:9px;color:var(--ui-muted);font-weight:750}.cbt-question-head h1{font-size:37px;letter-spacing:-.055em;margin:6px 0 0}.cbt-progress-label{font-size:9px;color:var(--ui-muted)}.cbt-instruction-strip{max-width:900px;margin:0 auto 12px;display:flex;gap:7px;flex-wrap:wrap}.cbt-instruction-strip span{padding:6px 9px;border-radius:999px;background:rgba(0,0,0,.035);color:var(--ui-muted);font-size:8px}.app[data-appearance='dark'] .cbt-instruction-strip span{background:rgba(255,255,255,.05)}.cbt-instruction-strip b{color:#007aff}.cbt-question-type{margin-left:auto}.cbt-question-card{max-width:900px;margin:0 auto;padding:30px;border-radius:26px;border:1px solid var(--ui-line);background:var(--ui-card);box-shadow:0 12px 45px rgba(0,0,0,.045)}.cbt-q-number{font-size:9px;color:var(--ui-muted);font-weight:750}.cbt-dropped-badge{margin-left:7px;color:#ff3b30}.cbt-question-text{font-size:23px;line-height:1.58;letter-spacing:-.025em;margin:18px 0 15px;font-weight:600}.cbt-source-toggle{display:flex;justify-content:space-between;gap:15px;align-items:center;padding:10px 0;border-top:1px solid var(--ui-line);border-bottom:1px solid var(--ui-line)}.cbt-source-toggle button{border:0;background:none;color:#007aff;font-size:9px;font-weight:650}.cbt-source-toggle span{color:var(--ui-muted);font-size:8px}.cbt-options-heading{display:flex;align-items:baseline;gap:8px;margin:22px 0 10px}.cbt-options-heading strong{font-size:12px}.cbt-options-heading span{font-size:9px;color:var(--ui-muted)}.cbt-options{display:grid;grid-template-columns:1fr 1fr;gap:10px}.cbt-option{min-height:76px;display:grid;grid-template-columns:38px 22px 1fr;align-items:center;gap:10px;padding:14px 15px;border:1px solid var(--ui-line);border-radius:17px;background:rgba(0,0,0,.018);color:inherit;text-align:left;transition:.18s}.app[data-appearance='dark'] .cbt-option{background:rgba(255,255,255,.035)}.cbt-option:hover{transform:translateY(-1px);border-color:rgba(0,122,255,.25)}.cbt-option .option-radio{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;border:1.5px solid #c7c7cc;color:transparent}.cbt-option b{font-size:10px;color:var(--ui-muted)}.cbt-option-label{font-size:12px;line-height:1.5}.cbt-option.selected{border-color:#007aff;background:rgba(0,122,255,.06);box-shadow:inset 3px 0 #007aff}.cbt-option.selected .option-radio{border-color:#007aff;color:#007aff}.cbt-palette{padding:22px;border-left:1px solid var(--ui-line);background:var(--ui-card);overflow:auto}.cbt-candidate{display:flex;align-items:center;gap:9px}.candidate-avatar{width:38px;height:38px;border-radius:50%;display:grid;place-items:center;background:#f2f2f7;color:#6e6e73;font-weight:750}.cbt-candidate>div:nth-child(2){flex:1}.cbt-candidate small,.cbt-candidate strong{display:block}.cbt-candidate small{font-size:8px;color:var(--ui-muted)}.cbt-candidate strong{font-size:11px;margin-top:2px}.cbt-candidate button{border:0;background:none;color:var(--ui-muted)}.cbt-palette-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:5px;margin:22px 0}.cbt-palette-summary strong{text-align:center;font-size:15px}.cbt-palette-summary span{text-align:center;font-size:7px;color:var(--ui-muted)}.cbt-palette-title{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px}.cbt-palette-title b{font-size:11px}.cbt-palette-title span{font-size:8px;color:var(--ui-muted)}.cbt-palette-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:7px}.palette-q{height:35px;border-radius:10px;border:1px solid var(--ui-line);background:transparent;color:var(--ui-muted);font-size:9px}.palette-q.current{outline:2px solid #007aff;outline-offset:1px}.palette-q.answered{background:rgba(52,199,89,.12);color:#34c759;border-color:rgba(52,199,89,.2)}.palette-q.review{background:rgba(255,149,0,.12);color:#ff9500}.palette-q.answered-review{background:rgba(175,82,222,.12);color:#af52de}.cbt-legend{display:grid;gap:8px;margin:20px 0;color:var(--ui-muted);font-size:8px}.cbt-legend i{display:inline-block;width:8px;height:8px;border-radius:3px;margin-right:6px;background:#ddd}.cbt-submit{width:100%;border:0;border-radius:999px;background:#007aff;color:#fff;padding:11px;font-size:10px;font-weight:700}.cbt-footer{height:60px;position:fixed;left:0;right:300px;bottom:0;display:flex;align-items:center;gap:16px;padding:0 24px;background:rgba(255,255,255,.88);border-top:1px solid var(--ui-line);backdrop-filter:blur(22px);z-index:4}.app[data-appearance='dark'] .cbt-footer{background:rgba(18,18,20,.9)}.cbt-footer button{border:0;background:none;color:var(--ui-muted);font-size:9px}.cbt-footer-center{flex:1;display:flex;align-items:center;gap:12px;justify-content:center}.cbt-dots{width:120px;height:4px;border-radius:99px;background:rgba(0,0,0,.08);overflow:hidden}.app[data-appearance='dark'] .cbt-dots{background:rgba(255,255,255,.08)}.cbt-dots i{display:block;height:100%;background:#007aff;border-radius:inherit}.cbt-footer-right{display:flex;gap:7px}.cbt-footer-right .primary-button{padding:9px 13px}.cbt-mobile-section,.cbt-actions-mobile{display:none}
    .result-overlay{position:fixed;inset:0;z-index:110;display:grid;place-items:center;padding:24px;background:rgba(0,0,0,.38);backdrop-filter:blur(24px)}.result-sheet{width:min(640px,calc(100vw - 32px));padding:34px;border-radius:30px;background:var(--ui-bg);color:var(--ui-text);box-shadow:0 30px 90px rgba(0,0,0,.25)}.result-sheet h1{font-size:30px;letter-spacing:-.05em;margin:7px 0 25px}.score-hero{display:grid;grid-template-columns:1fr 120px;gap:20px;align-items:center;padding:22px;border-radius:22px;background:#1d1d1f;color:#fff}.app[data-appearance='dark'] .score-hero{background:#1c1d21}.score-hero small,.score-hero span{font-size:9px;color:#aaa}.score-hero strong{display:inline-block;font-size:64px;letter-spacing:-.07em;margin-right:7px}.score-ring{width:100px;height:100px;border-radius:50%;display:grid;place-items:center;background:conic-gradient(#0a84ff var(--score),rgba(255,255,255,.1) 0);position:relative;text-align:center}.score-ring:after{content:"";position:absolute;inset:8px;border-radius:50%;background:#1d1d1f}.score-ring b,.score-ring small{position:relative;z-index:1}.score-ring b{font-size:18px}.score-ring small{display:block}.result-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin:10px 0}.result-stats>div{padding:14px;border-radius:16px;background:var(--ui-card);border:1px solid var(--ui-line)}.result-stats b,.result-stats small{display:block}.result-stats b{font-size:18px}.result-stats small{font-size:8px;color:var(--ui-muted);margin-top:3px}.result-actions{display:flex;gap:8px;margin-top:16px}.result-actions>*{flex:1}
    .modal-backdrop{background:rgba(0,0,0,.38);backdrop-filter:blur(25px)}.modal{border:1px solid var(--ui-line);border-radius:28px;background:var(--ui-bg);color:var(--ui-text);box-shadow:0 30px 90px rgba(0,0,0,.22)}.close-button{width:34px;height:34px;border-radius:50%;border:0;background:rgba(0,0,0,.06);color:inherit}.app[data-appearance='dark'] .close-button{background:rgba(255,255,255,.08)}
    .mobile-bottom{display:none}
    @media(max-width:900px){.page{width:min(100% - 40px,720px);padding:45px 0 100px}.student-home-stage{width:100%;padding:0 20px}.top-nav{grid-template-columns:auto 1fr auto;padding:0 20px}.top-nav nav{display:none}.page-title h1{font-size:46px}.mock-builder-hero{grid-template-columns:1fr}.mock-builder-grid{grid-template-columns:1fr}.mock-rules-card{position:static}.metrics-grid{grid-template-columns:1fr 1fr}.cbt-layout{grid-template-columns:1fr}.cbt-palette{position:fixed;top:66px;right:0;bottom:60px;width:min(340px,90vw);z-index:5;transform:translateX(100%);transition:.25s;box-shadow:-20px 0 60px rgba(0,0,0,.12)}.cbt-palette.open{transform:translateX(0)}.cbt-footer{right:0}.cbt-question-area{padding-left:24px;padding-right:24px}.cbt-mobile-section{display:flex;height:44px;align-items:center;justify-content:space-between;padding:0 20px;border-bottom:1px solid var(--ui-line);font-size:9px}.cbt-mobile-section button{border:0;background:rgba(0,122,255,.08);color:#007aff;border-radius:999px;padding:7px 10px;font-size:8px}.cbt-actions-mobile{display:flex;position:fixed;left:10px;right:10px;bottom:10px;height:60px;padding:5px;border:1px solid var(--ui-line);border-radius:21px;background:rgba(255,255,255,.9);backdrop-filter:blur(22px);z-index:8;box-shadow:0 12px 35px rgba(0,0,0,.12)}.app[data-appearance='dark'] .cbt-actions-mobile{background:rgba(24,24,27,.9)}.cbt-actions-mobile button{flex:1;border:0;background:none;color:var(--ui-muted);border-radius:15px;font-size:8px}.cbt-actions-mobile b{display:block;font-size:8px;margin-top:3px}.cbt-mobile-primary{background:#007aff!important;color:#fff!important;border-radius:16px!important}.cbt-mobile-end{max-width:36px}.cbt-footer{display:none}.cbt-question-text{font-size:20px}.cbt-question-card{padding:22px;border-radius:23px}.cbt-options{grid-template-columns:1fr}.cbt-option{min-height:68px}.cbt-source-toggle span{display:none}.result-sheet{padding:25px;border-radius:25px}}
    @media(max-width:600px){.top-nav{display:none}.page{width:100%;padding:24px 16px 105px}.student-home-stage{padding:0 16px}.page-title h1{font-size:40px}.page-title{margin-bottom:20px}.page-title p{font-size:12px}.filter-panel{grid-template-columns:1fr;padding:8px;border-radius:18px}.filter-row{overflow:auto}.filter-row select{min-width:125px;height:43px}.question-row{grid-template-columns:40px 1fr 12px;gap:10px;min-height:86px;padding:12px;border-radius:17px}.q-number{width:38px;height:38px;border-radius:12px}.q-row-copy b{font-size:11px}.metrics-grid{gap:8px}.metric-card{min-height:130px;padding:15px;border-radius:18px}.metric-card strong{font-size:34px;margin-top:22px}.performance-panel{padding:16px;border-radius:20px}.mock-builder-hero h1{font-size:40px}.subject-select-grid{grid-template-columns:1fr}.builder-card,.mock-rules-card{padding:16px;border-radius:19px}.cbt-topbar{height:58px;grid-template-columns:1fr auto;padding:0 14px}.cbt-section-tabs,.cbt-lang{display:none}.cbt-brand strong{font-size:14px}.cbt-layout{height:calc(100vh - 102px)}.cbt-question-area{padding:22px 14px 92px}.cbt-question-head h1{font-size:31px}.cbt-question-card{padding:19px}.cbt-question-text{font-size:18px;line-height:1.58}.cbt-option-label{font-size:11px}.result-stats{grid-template-columns:1fr 1fr}.result-actions{flex-direction:column}.score-hero{grid-template-columns:1fr 90px}.score-hero strong{font-size:52px}.score-ring{width:82px;height:82px}.mobile-bottom{position:fixed;display:grid;grid-template-columns:repeat(5,1fr);left:10px;right:10px;bottom:10px;height:66px;padding:5px;border:1px solid var(--ui-line);border-radius:23px;background:rgba(255,255,255,.88);backdrop-filter:blur(25px);z-index:80;box-shadow:0 15px 40px rgba(0,0,0,.13)}.app[data-appearance='dark'] .mobile-bottom{background:rgba(24,24,27,.9)}.mobile-bottom button{border:0;background:transparent;color:var(--ui-muted);border-radius:17px}.mobile-bottom button.active{background:rgba(0,122,255,.09);color:#007aff}.mobile-bottom button b{display:block;font-size:7px;margin-top:3px}.mobile-bottom .mobile-plus{width:50px;height:50px;align-self:center;justify-self:center;border-radius:17px;background:#007aff;color:#fff;font-size:27px;box-shadow:0 8px 24px rgba(0,122,255,.25)}.mobile-bottom .mobile-plus b{display:none}.mobile-bottom .mobile-plus span{display:grid;place-items:center}}
