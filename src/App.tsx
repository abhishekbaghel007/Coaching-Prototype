...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (!current || current.__neetprepBackGuard !== marker) {
      window.history.pushState({ ...(current || {}), __neetprepBackGuard: marker }, '', window.location.href);
    }
    const onPopState = () => {
      setBackMenuOpen(true);
      window.history.pushState({ __neetprepBackGuard: marker }, '', window.location.href);
    };
