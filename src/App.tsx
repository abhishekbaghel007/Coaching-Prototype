...
export default function App() {
  ...
  function renderMobileHome() {
    return <StudentExperience
      ...
      onPractice={(count, title) => startAttempt(questions.filter(q => q.status !== 'dropped').slice(0, count), 'practice', title)}
      onGo={(next) => go(next)}
  ...
  const mobilePolishCss = `
    .student-os{max-width:560px;padding:6px 16px 128px;margin:0 auto;overflow:hidden}.os-hero{min-height:185px;display:flex;justify-content:space-between;gap:15px;padding:25px 4px 16px;position:relative}.os-hero:after{content:'';position:absolute;width:230px;height:230px;right:-150px;top:-80px;border-radius:50%;background:radial-gradient(circle,color-mix(in srgb,var(--accent) 14%,transparent),transparent 67%);pointer-events:none}.os-eyebrow,.os-kicker{display:flex;align-items:center;gap:6px;color:var(--muted);font:900 8px/1 Manrope;letter-spacing:.16em;text-transform:uppercase}.os-pulse{width:5px;height:5px;border-radius:50%;background:var(--accent);box-shadow:0 0 14px color-mix(in srgb,var(--accent) 80%,transparent)}.os-hero h1{font:800 41px/1.02 Manrope;letter-spacing:-.07em;margin:12px 0 9px}.os-hero h1 em{font-style:normal;color:var(--accent)}.os-hero p{max-width:275px;margin:0;color:var(--muted);font-size:11px;line-height:1.55}.os-dna-button{position:relative;z-index:2;width:62px;height:74px;border:1px solid color-mix(in srgb,var(--line) 78%,transparent);border-radius:22px;background:color-mix(in srgb,var(--panel) 82%,transparent);color:var(--text);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:inset 0 1px rgba(255,255,255,.06)}.os-dna-ring{width:32px;height:32px;border-radius:50%;display:grid;place-items:center;border:1px solid color-mix(in srgb,var(--accent) 40%,var(--line));color:var(--accent);box-shadow:0 0 24px color-mix(in srgb,var(--accent) 12%,transparent)}.os-dna-button small{font:900 6px Manrope;letter-spacing:.14em;color:var(--muted)}.os-command-card{border:1px solid color-mix(in srgb,var(--accent) 20%,var(--line));border-radius:30px;padding:22px;background:linear-gradient(140deg,#103b39 0%,#102b30 54%,#171d25 100%);box-shadow:0 24px 65px rgba(0,0,0,.25),inset 0 1px rgba(255,255,255,.06);color:#f5fbfa}.os-command-top{display:flex;align-items:center;justify-content:space-between;gap:16px}.os-command-top strong{display:block;font:800 27px/1.03 Manrope;letter-spacing:-.055em;margin:10px 0 7px}.os-command-top p{margin:0;max-width:260px;color:#b7c8c8;font-size:10px;line-height:1.5}.os-ring{width:76px;height:76px;flex:0 0 76px;border-radius:50%;display:grid;place-items:center;background:conic-gradient(#77df73 var(--p),rgba(255,255,255,.09) 0);position:relative}.os-ring:after{content:'';position:absolute;inset:7px;border-radius:50%;background:#16272b}.os-ring span{position:relative;z-index:1;font:800 12px Manrope}.os-primary{margin-top:20px;width:100%;height:49px;border:0;border-radius:16px;background:#fff;color:#143033;display:flex;align-items:center;justify-content:space-between;padding:0 16px;font:900 10px Manrope;box-shadow:0 10px 28px rgba(0,0,0,.16),inset 0 1px rgba(255,255,255,.5)}.os-primary svg{width:15px}.os-recovery{margin-top:11px;display:grid;grid-template-columns:40px minmax(0,1fr) auto;gap:11px;align-items:center;padding:14px 15px;border:1px solid color-mix(in srgb,#ffb36c 17%,var(--line));border-radius:22px;background:linear-gradient(135deg,color-mix(in srgb,#ffb36c 6%,var(--panel)),color-mix(in srgb,var(--panel-strong) 76%,transparent))}.os-recovery-icon{width:40px;height:40px;border-radius:13px;display:grid;place-items:center;color:#ffb36c;background:color-mix(in srgb,#ffb36c 10%,var(--panel))}.os-recovery-copy{min-width:0}.os-recovery-copy strong{display:block;margin-top:6px;font:800 18px/1 Manrope;letter-spacing:-.04em}.os-recovery-copy p{margin:4px 0 0;color:var(--muted);font-size:9px;line-height:1.45}.os-recovery>button{border:0;background:none;color:#ffb36c;font:900 8px Manrope;white-space:nowrap}.os-recovery>button b{font-size:13px;margin-left:2px}.os-section{margin-top:25px}.os-section-head{display:flex;align-items:flex-end;justify-content:space-between;gap:10px;margin:0 4px 11px}.os-section-head h2{margin:7px 0 0;font:800 21px/1 Manrope;letter-spacing:-.05em}.os-week-stat,.os-micro-count{font:900 8px Manrope;color:var(--accent);padding:7px 9px;border:1px solid color-mix(in srgb,var(--accent) 17%,var(--line));border-radius:999px;background:color-mix(in srgb,var(--accent) 5%,transparent)}.os-week{height:118px;display:grid;grid-template-columns:repeat(7,1fr);gap:8px;padding:11px 8px 5px;border:1px solid var(--line);border-radius:22px;background:color-mix(in srgb,var(--panel) 75%,transparent);position:relative;overflow:hidden}.os-week-lines{position:absolute;inset:15px 9px 25px;display:flex;flex-direction:column;justify-content:space-between;pointer-events:none}.os-week-lines i{height:1px;background:color-mix(in srgb,var(--line) 55%,transparent)}.os-day{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;gap:6px}.os-day>span{font:800 7px Manrope;color:var(--muted)}.os-day b{width:100%;max-width:22px;height:var(--h);min-height:6px;border-radius:8px 8px 4px 4px;background:color-mix(in srgb,var(--line) 80%,transparent);display:flex;align-items:flex-start;justify-content:center;position:relative}.os-day b.filled{background:linear-gradient(180deg,color-mix(in srgb,var(--accent) 90%,white),color-mix(in srgb,var(--accent) 48%,transparent));box-shadow:0 8px 18px color-mix(in srgb,var(--accent) 10%,transparent)}.os-day b:after{content:'';position:absolute;bottom:-5px;width:4px;height:4px;border-radius:50%;background:var(--line)}.os-day:last-child b:after{background:var(--accent);box-shadow:0 0 10px var(--accent)}.os-day small{font:900 6px Manrope;color:#071012;margin-top:4px}.os-missions{display:grid;gap:7px}.os-missions button{display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;width:100%;min-height:61px;padding:8px 11px;border:1px solid var(--line);border-radius:18px;background:color-mix(in srgb,var(--panel) 75%,transparent);color:var(--text);text-align:left}.os-missions button.done{border-color:color-mix(in srgb,var(--accent) 30%,var(--line));background:color-mix(in srgb,var(--accent) 7%,var(--panel))}.os-check{width:32px;height:32px;border-radius:11px;display:grid;place-items:center;background:color-mix(in srgb,var(--line) 48%,transparent);color:var(--muted);font:900 8px Manrope}.done .os-check{background:color-mix(in srgb,var(--accent) 16%,transparent);color:var(--accent)}.os-missions b{display:block;font:800 11px Manrope}.os-missions small{display:block;color:var(--muted);font-size:8px;margin-top:3px}.os-missions em{font:900 7px Manrope;color:var(--muted);font-style:normal}.done em{color:var(--accent)}.os-text-button{border:0;background:none;color:var(--accent);font:900 8px Manrope;padding:0 0 2px}.os-lanes{display:grid;grid-template-columns:1fr 1fr;gap:8px}.os-lanes button{min-height:86px;padding:13px;border:1px solid var(--line);border-radius:19px;background:color-mix(in srgb,var(--panel) 75%,transparent);color:var(--text);display:grid;grid-template-columns:32px minmax(0,1fr);grid-template-rows:auto 1fr;column-gap:9px;text-align:left;position:relative}.os-lanes button>svg{position:absolute;right:12px;bottom:13px;width:14px;color:var(--muted)}.os-lane-icon{width:32px;height:32px;border-radius:11px;display:grid;place-items:center;grid-row:span 2}.os-lane-icon svg{width:16px}.os-lane-icon.violet{color:#b09cff;background:color-mix(in srgb,#9b7cff 11%,var(--panel))}.os-lane-icon.coral{color:#ff9b90;background:color-mix(in srgb,#ff8e82 11%,var(--panel))}.os-lane-icon.blue{color:#7fb3ff;background:color-mix(in srgb,#6da8ff 11%,var(--panel))}.os-lane-icon.mint{color:#72e0a2;background:color-mix(in srgb,#63d59a 11%,var(--panel))}.os-lanes b{font:800 10px Manrope;align-self:end}.os-lanes small{font-size:7px;color:var(--muted);align-self:start;margin-top:4px}.os-insight{margin-top:11px;padding:16px;border:1px solid color-mix(in srgb,var(--accent) 16%,var(--line));border-radius:22px;background:linear-gradient(135deg,color-mix(in srgb,var(--accent) 6%,var(--panel)),color-mix(in srgb,var(--panel) 78%,transparent));display:grid;grid-template-columns:36px minmax(0,1fr) auto;gap:11px;align-items:start}.os-insight-icon{width:36px;height:36px;border-radius:12px;display:grid;place-items:center;color:var(--accent);background:color-mix(in srgb,var(--accent) 10%,var(--panel))}.os-insight-icon svg{width:17px}.os-insight strong{display:block;margin-top:6px;font:800 12px/1.2 Manrope}.os-insight p{margin:5px 0 0;color:var(--muted);font-size:8.5px;line-height:1.5}.os-insight button{border:0;background:none;color:var(--accent);font:900 8px Manrope;padding:4px 0}.os-announcement{width:100%;display:grid;grid-template-columns:38px minmax(0,1fr) auto;gap:10px;align-items:center;text-align:left;padding:12px;border:1px solid var(--line);border-radius:18px;background:color-mix(in srgb,var(--panel) 75%,transparent);color:var(--text)}.os-announcement>span:first-child{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;color:var(--accent);background:color-mix(in srgb,var(--accent) 9%,var(--panel))}.os-announcement b{font:800 10px Manrope}.os-announcement small{display:block;color:var(--muted);font-size:8px;margin-top:3px}.os-announcement>b{color:var(--accent);font-size:14px}.os-level-card{margin-top:11px;padding:17px;border:1px solid var(--line);border-radius:21px;background:color-mix(in srgb,var(--panel) 78%,transparent)}.os-level-card strong{display:block;font:800 15px Manrope;margin-top:6px}.os-level-card p{margin:4px 0 12px;color:var(--muted);font-size:8px}.os-level-track{height:6px;border-radius:99px;background:color-mix(in srgb,var(--line) 55%,transparent);overflow:hidden}.os-level-track i{display:block;height:100%;border-radius:99px;background:var(--accent);box-shadow:0 0 14px color-mix(in srgb,var(--accent) 35%,transparent)}.os-level-card>small{display:block;margin-top:6px;color:var(--muted);font-size:7px;text-align:right}.os-backdrop{position:fixed;inset:0;z-index:500;background:rgba(2,5,7,.68);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);display:flex;align-items:flex-end;justify-content:center;padding:12px}.os-modal,.os-tool-sheet{width:min(560px,100%);max-height:88dvh;overflow:auto;padding:24px 19px 20px;border:1px solid color-mix(in srgb,var(--line) 90%,transparent);border-radius:28px;background:color-mix(in srgb,var(--panel-strong) 96%,transparent);box-shadow:0 30px 100px rgba(0,0,0,.55),inset 0 1px rgba(255,255,255,.07);position:relative}.os-modal h2,.os-tool-sheet h2{font:800 25px/1.05 Manrope;letter-spacing:-.06em;margin:9px 0 7px}.os-modal>p{color:var(--muted);font-size:9px;line-height:1.5;margin:0 0 18px}.os-close{position:absolute;right:13px;top:13px;width:36px;height:36px;border:1px solid var(--line);border-radius:12px;background:var(--panel);color:var(--muted);font-size:19px}.os-modal label{display:block;color:var(--muted);font:800 8px Manrope;margin:13px 0}.os-modal select{display:block;width:100%;height:45px;margin-top:6px;border:1px solid var(--line);border-radius:13px;background:var(--panel);color:var(--text);padding:0 11px;font-size:10px}.os-modal input[type=range]{width:100%;accent-color:var(--accent);margin-top:10px}.os-range-value{display:block;color:var(--accent);font:900 9px Manrope;margin-top:6px}.os-modal-preview{margin:17px 0;padding:14px;border-radius:16px;border:1px solid color-mix(in srgb,var(--accent) 15%,var(--line));background:color-mix(in srgb,var(--accent) 5%,var(--panel))}.os-modal-preview span{display:block;color:var(--accent);font:900 7px Manrope;letter-spacing:.14em}.os-modal-preview strong{display:block;margin-top:7px;font:800 11px Manrope}.os-primary.full{margin-top:0;justify-content:center}.os-tool-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:18px}.os-tool-grid button{min-height:104px;padding:14px;border:1px solid var(--line);border-radius:18px;background:color-mix(in srgb,var(--panel) 72%,transparent);color:var(--text);text-align:left}.os-tool-grid button>span{width:32px;height:32px;border-radius:11px;display:grid;place-items:center;background:color-mix(in srgb,var(--accent) 9%,var(--panel));color:var(--accent);margin-bottom:13px}.os-tool-grid button>span svg{width:16px}.os-tool-grid b{display:block;font:800 10px Manrope}.os-tool-grid small{display:block;color:var(--muted);font-size:7px;margin-top:4px}.os-next-tools{margin-top:11px;padding:13px;border:1px dashed color-mix(in srgb,var(--line) 80%,transparent);border-radius:16px}.os-next-tools span{display:block;color:var(--muted);font:900 6px Manrope;letter-spacing:.14em}.os-next-tools b{display:block;margin-top:6px;color:var(--muted);font:700 8px/1.55 Manrope}
    @media(max-width:430px){.student-os{padding-left:12px;padding-right:12px}.os-hero{padding-top:22px}.os-hero h1{font-size:38px}.os-command-card{border-radius:27px;padding:19px}.os-recovery{grid-template-columns:38px minmax(0,1fr) auto;padding:13px}.os-lanes{gap:7px}.os-lanes button{min-height:82px;padding:11px}.os-backdrop{padding:7px}.os-modal,.os-tool-sheet{border-radius:25px;padding-left:16px;padding-right:16px}.os-tool-grid{gap:7px}}
